...
OD_ATTR_RAM OD_RAM_t OD_RAM = {
    ...
    .x2000_motorPolePairs = 0x04,
    .x2001_permanentMagnetFluxLinkage = 0.00674,
    .x2002_ratedPhaseCurrentPeak = 5.0,
    .x2003_maximumMechanicalSpeed = 314.159265359,
    .x2004_torqueCoefficient = 0.04044,
    ...
    .x6075_motorRatedCurrent = 0x00001388,
    .x6076_motorRatedTorque = 0x000000CA,
